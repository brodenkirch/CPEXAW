...
cases_dict = {'1': ['20170610', 'Western Atlantic', 'Isolated'], 
              '2': ['20170624', 'Caribbean', 'Isolated', '180000','200000'], 
              '3': ['20170624', 'Gulf', 'Isolated', '200000','220000'], 
              '4': ['20170615', 'Caribbean', 'Organized'], 
              '5': ['20170616', 'Caribbean', 'Organized'], 
              '6': ['20170601', 'Gulf', 'Organized'], 
              '7': ['20170606', 'Gulf', 'Organized'], 
              '8': ['20170617', 'Caribbean', 'Organized'], 
              '9': ['20170619', 'Gulf', 'Organized'], 
              '10': ['20170620', 'Gulf', 'Organized'], 
              '11': ['20170602', 'Gulf', 'Scattered'], 
              '12a': ['20170611', 'Gulf', 'Scattered', '170000', '174500'], 
              '12b': ['20170611', 'Gulf', 'Scattered', '210000', '214500'], 
              '13': ['20170611', 'Gulf', 'Organized', '174500', '210000'],
              '14': ['20210821', 'Western Atlantic', 'Organized'], 
              '15': ['20210822', 'Western Atlantic', 'Isolated'], 
              '16': ['20210824', 'Caribbean', 'Organized'],
              '17': ['20210826', 'Caribbean', 'Organized'],
              '18': ['20210828', 'Western Atlantic', 'Organized'],
              '19': ['20210901', 'Western Atlantic', 'Organized'],
              '20': ['20210904', 'Western Atlantic', 'Organized']}
    ...
    for profile in dawn_group:  #calculate DAWN shear for each qualifying DAWN profile
        ...
        if (len(height[height < 1000]) >= 20) and (abs(top_height - lowest_max_height) <= tolerance) and (abs(height500 - sfc_height) <= tolerance):
            ...
            for case_num in cases_dict:
                ...
                if day == full_date:
                    if len(cases_dict[case_num]) == 3:  #if full_date does not have multiple cases
                        case = int(case_num[0:2])
                        region = cases_dict[case_num][1]
                        convective_type = cases_dict[case_num][2]
                        break
                    else:  #if full_date has multiple cases
                        if time >= cases_dict[case_num][3] and time < cases_dict[case_num][4]:
                            case = int(case_num[0:2])
                            region = cases_dict[case_num][1]
                            convective_type = cases_dict[case_num][2]
                            break
...
if use_median_winds:
    final_name = os.path.join(os.getcwd(), 'DAWN_Shear_Calculations_medianShear.csv')
if use_average_winds:
    final_name = os.path.join(os.getcwd(), 'DAWN_Shear_Calculations_averageShear.csv')
if use_normal_winds:
    final_name = os.path.join(os.getcwd(), 'DAWN_Shear_Calculations.csv')
